     ...
     this.button.position(displayWidth - 900 , displayHeight/2 + 20);
        ...
        if(showAnswer){
          if(player.answer == "b"){
            fill("red");
            textSize(20);
            text("COREECT ANSWER" ,displayWidth/2 - 160 , displayHeight/2 - 100 )
          } else{
            fill("red");
            textSize(20);
            text("WRONG ANSWER" , displayWidth/2 - 160 , displayHeight/2 - 100 )
          }
        }
